...
Module Graphing
    Public GraphColorArray As System.Drawing.Color() = {Color.Red, Color.Green, Color.Blue, Color.Purple, Color.Yellow, Color.Cyan, ColorTranslator.FromHtml("#c87f00"), ColorTranslator.FromHtml("#c8c880"), ColorTranslator.FromHtml("#c880c8"), ColorTranslator.FromHtml("#80ff00"), Color.Black}
